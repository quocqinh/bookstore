...
?>
	...
	<p class="lead"><a href="admin_add.php" class="btn btn-primary">Add new book</a>
	<a href="admin_customer.php" class="btn btn-primary">Order</a>

	<a href="admin_search.php" class="btn btn-primary">Search</a>
	<a href="admin_signout.php" class="btn btn-primary">Sign out!</a></p>
